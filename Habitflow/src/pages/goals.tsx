        ...
        contents: [
          {
            parts: [
              {
                text: `You are an AI career planner.Based on the user's goal, return ONLY valid JSON.
Do not use markdown.
...
{
  "mainGoal": "string",
  "summary": "string" + "in a detailed manner",
  "suggestedRoadmap": [
    {
      "title": "string",
      "description": "string"
...
// console.log(goal.suggestedRoadmap[0].description);
// this is test you can ignore this part. for git    
}}
                            className="
px-8
py-3
